...
namespace CSCore.Streams.Effects
{
    ...
    /// </summary>
    public class FlangerEffect : DmoEffectBase<DirectSoundFXFlanger, FlangerParameters>
    {
        /// <summary>
        /// Creates a new instance of the <see cref="FlangerEffect"/> class.
        /// </summary>
        /// <param name="source">The base source, which feeds the effect with data.</param>
        public FlangerEffect(IWaveSource source) : base(source)
        {
