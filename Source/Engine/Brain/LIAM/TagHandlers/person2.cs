...
namespace LIAM.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person2 : LIAM.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person2")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return LIAM.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.Person2Substitutions, this.templateNode.InnerText);
                }
                else
                {
