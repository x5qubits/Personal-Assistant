...
namespace LIAM.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person : LIAM.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return LIAM.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.PersonSubstitutions, this.templateNode.InnerText);
                }
                else
                {
