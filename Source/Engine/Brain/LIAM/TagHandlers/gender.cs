...
namespace LIAM.AIMLTagHandlers
{
    ...
    /// </summary>
    public class gender : LIAM.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "gender")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return LIAM.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.GenderSubstitutions, this.templateNode.InnerText);
                }
                else
                {
