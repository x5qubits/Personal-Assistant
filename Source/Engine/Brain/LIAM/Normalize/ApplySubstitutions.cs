...
namespace LIAM.Normalize
{
    ...
    /// </summary>
    public class ApplySubstitutions : LIAM.Utils.TextTransformer
    {
        public ApplySubstitutions(LIAM.Bot bot, string inputString)
            : base(bot, inputString)
        { }

        public ApplySubstitutions(LIAM.Bot bot)
            : base(bot)
        { }
        ...
        public static string Substitute(LIAM.Bot bot, LIAM.Utils.SettingsDictionary dictionary, string target)
        {
