...
namespace LIAM.Utils
{
    ...
    public class Node
    {
        ...
        /// <param name="utterance">the template to find at the end of the path</param>
        /// <param name="filename">the file that was the source of this category</param>
        public void addCategory(string path, string template, Intent filename)
        {
            ...
            if (path.Trim().Length == 0)
            {
                ...
                this.filename = filename.PathToFile;
                this.IdentId = filename;
                return;
            }
